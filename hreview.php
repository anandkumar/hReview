...
/*
Plugin Name: hReview
Plugin URI: http://www.blogsynthesis.com/plugins/ahreview/#utm_source=wpadmin&utm_medium=plugin&utm_campaign=hReviewPlugin
...
Last Version update : 15 May 2014
Support: http://www.wpavenue.com/support/

WordPress hReview Plugin
Copyright (C) 2014, Anand Kumar - anand@blogsynthesis.com

Disclaimer: This plugin is based on Hesham Zebida's Author hReview Plugin (https://wordpress.org/plugins/author-hreview/).
...
*/
	...
	// require_once ('include/news.php');									// load blog news
	...
	*/
	function arwp_stylesheet() {
        ...
        $myStyleFile = WP_PLUGIN_DIR . '/hreview/style/style.css';
