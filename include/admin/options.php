...
function wpar_add_options_page() {
	...
	add_menu_page(
							...
							'synthhreview',
							'wpar_render_form',
							plugin_dir_url( 'hreview/images/stars_admin.png' , __FILE__ ).'stars_admin.png',
							49
						);
		
	// set second menu item title
	add_submenu_page('synthhreview','Settings','Settings','manage_options','synthhreview','wpar_render_form');
}
...
function wpar_plugin_action_links( $links, $file ) {
	...
	if ( $file == plugin_basename( __FILE__ ) ) {
		$posk_links = '<a href="'.get_admin_url().'options-general.php?page=hreview.php">'.__('Settings').'</a>';
...
function wpar_admin_links() { ?>
        ...
        <div class="wpar_admin_link">
            <ul>
				<li><p>
                	<a href="http://wordpress.org/extend/plugins/hreview/" target="_blank"><p>Rate the plugin 5★ on WordPress.org</p></a></p>
				</li>
                <li class="wpar_blog"><p>
                	<a href="http://synthhreview.com/" title="Author hReview" target="_blank"><p>Blog about it and link to the plugin site</p></a></p>
				</li>
